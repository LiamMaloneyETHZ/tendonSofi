...
import sys, time, math, os, datetime
...
def start_server():
    @app.route('/')
    def index():
        return render_template('index_berry.html')
...
while True:
    ...
    current_data.update({
        ...
        "pitch": CFangleY,
        "yaw": heading,
        "gyro_roll": gyroXangle,
        "gyro_pitch": gyroYangle,
        "gyro_yaw": gyroZangle,
        "kalman_roll": kalmanX,
        "kalman_pitch": kalmanY,
        "tilt_heading": tiltCompensatedHeading,
        "accx": ACCx,
        "accy": ACCy,
        "accz": ACCz,
        "gyrx": GYRx,
    ...
    if recording:
        recorded_data.append(current_data.copy())
